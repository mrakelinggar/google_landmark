...
#Edited from https://www.kaggle.com/anisayari/download-images-dataset-python3-log-progressbar
...
#Add socket timeout to avoid lags
import socket
...
def Run():
    #eturn print('COMMENT ME ! Please run this code on your machine not on a kernel and comment this line :)')
    if not os.path.exists(out_dir):
        os.mkdir(out_dir)

    key_url_list = ParseData(data_file)
    pool = multiprocessing.Pool(processes=32)  #Adjust number of process regarding to your machine performance
    try:
